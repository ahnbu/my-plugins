...
Agile 방법론에서 나온 회고(Retrospective) 프레임워크로, 3개 축으로 반성과 개선을 구조화한다:[](https://easyretro.io/templates/keep-problem-try-kpt/)

스프린트/주간 단위로 루틴하게 하면, 단순 일지와 달리 **Problem → Try로 액션이 연결**되는 게 핵심이다. `/evening`에서 대화형으로 KPT를 작성하고 `/weekly`에서 통합하는 구조는 이 흐름을 AI가 보조하는 방식으로, 회고가 실제 행동 변화로 이어지도록 설계된 워크플로우다.[](https://metroretro.io/templates/keep-problems-try-retrospective-template)

| 축                | 의미                | 질문                            |
| ----------------- | ------------------- | ------------------------------- |
| **K**eep    | 잘 됐으니 계속할 것 | "이건 앞으로도 유지하자"        |
| **P**roblem | 문제가 됐던 것      | "이건 방해가 됐거나 잘 안 됐다" |
| **T**ry     | 다음에 시도할 실험  | "이걸 바꿔보거나 새로 해보자"   |


# 업무 연속성 기억 file 시스템 - 링크드인 (김준범)

https://www.linkedin.com/posts/%EC%A4%80%EB%B2%94-%EA%B9%80-9b5809119_aiupqsqbtyp-slhrlgqtkree-snzsmgspf-share-7431989991058333696-zWSj/?utm_source=share&utm_medium=member_android&rcm=ACoAAEeG7JUBmAYkdijja-FrtAJT6XmXgy22WII

AI 비서 쓰다가 포기한 분들 많으시죠?
...
# 마누스 - [planning with files](https://www.linkedin.com/feed/update/urn:li:activity:7414070699071442944?updateEntityUrn=urn%3Ali%3Afs_updateV2%3A%28urn%3Ali%3Aactivity%3A7414070699071442944%2CFEED_DETAIL%2CEMPTY%2CDEFAULT%2Cfalse%29) (이정민)
...
# 마누스 - 유튜버 Jack Roberts : 문서관리시스템 -> '🛠️ Operating Principles'에 있음
